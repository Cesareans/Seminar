...
public interface CourseMemberLimitStrategyMapper {
     ...
     */
    @Insert("insert into course_member_limit_strategy(min_member, max_member, course_id) values(#{min}, #{max}, #{courseId})")
     ...
     */
    @Update("update course_member_limit_strategy set min_member=#{min}, max_member=#{max}, course_id=#{courseId} where id=#{id}")
